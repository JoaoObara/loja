...
<body>
    <div class="container">
        ...
        if (isset($_GET['id'])) :
            ...
            carros.descricao, carros.mod_fab, carros.cor, carros.placa, carros.valor FROM marcas, carros WHERE carros.marca = marcas.id_marca AND carros.id_carro=$id";
        ...
        <?php
            //recuperar nomes dos arquivos das fotos de um carro
            if (isset($_GET['id'])) :
                include INC_DIR . 'conecta_mysqli.inc';
        ...
        ?>
          ...
          while($dados = mysqli_fetch_array($resultado)) :
            ...
            //Recuperar dados em variaveis de um array
            $f_id = $dados['f_id'];
            $f_imagem = $dados['f_imagem'];
            $f_destaque = $dados['f_destaque'];
          ?>

            <form role="form" method="POST" action="php_action/update_foto.php" enctype="multipart/form-data">
                <div style="text-align: center;" class="col mt-3 mb-3">
